...
def create_complete_sdf_world(custom_obstacles=None):
    ...
    # Crea world
    world = ET.SubElement(sdf, 'world', name='custom_maze')
    ...
    ET.SubElement(plane, 'size').text = PLANE # DA PARAMETRIZZARE
    
    surface = ET.SubElement(collision, 'surface')
    friction = ET.SubElement(surface, 'friction')  #dal config 
    ...
    plane = ET.SubElement(geometry, 'plane')
    ET.SubElement(plane, 'normal').text = '0 0 1'
    ET.SubElement(plane, 'size').text = PLANE  #dal config 
    ...
    # Definizione dei dei bordi, di fatto potrebbero essere rimossi
    walls = [
    ...
    for wall_name, wall_pose, wall_size in walls:
        ...
        ET.SubElement(wall_link, 'static').text = 'true'
    ...
    ET.SubElement(obstacles, 'static').text = 'true'
    ...
    for obs_name, obs_pose, obs_size in obstacle_walls:
        ...
        ET.SubElement(obs_link, 'static').text = 'true'
...
def save_sdf(sdf_element, filename='world.sdf'):
    """
    Salva il file SDF
    """
